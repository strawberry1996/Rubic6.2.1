...
//				System.out.println( parameter_s_double[j]);
    ...
    public String creatResponse(){
        ...
        try {
            ...
            contentElement.setText("submit success");
            //-----------------end-------------------------------
    ...
    public static void main(String[] args) {
		String str = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" +
				...
				"        </protocol >\r\n" +
				"    </process>";
        String sendPack = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                "<process>" +
                "<type>request</type>" +
                "<protocol>" +
                "<protocol_id>1</protocol_id>" +
                ...
                "</protocol >" +
                "</process>";
        System.out.println(new JavaProtocol().parserRequest(sendPack));
...
//        System.out.println(new JavaProtocol().creatResponse());
